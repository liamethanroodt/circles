...
function HomePage() {
	...
	return (
		<div className="app-container">
			...
			<main className="main-content">
				...
				<div className="circles-container">
					<section className="circles-section" aria-labelledby="circles-heading">
						<div className="card">
							<h2 id="circles-heading" className="section-title">
								Your Circles
							</h2>
								...
								<form onSubmit={createPost} className="create-form">
										...
										<div className="pending-media-grid" role="list" aria-label="Files to attach">
											{pendingFiles.map((pf, i) => (
												<div key={i} className="pending-media-item" role="listitem">
													{pf.mediaType === "image" ? <img src={pf.previewUrl} alt={pf.file.name} /> : <video src={pf.previewUrl} muted />}
													<button
														type="button"
									...
									<div className="post-form-actions">
										...
										<input
											...
											aria-hidden="true"
										/>
										<button type="submit" className="primary-button" disabled={!newPostValue.trim() || uploading}>
											{uploading ? (
												<>
			...
			{/* Lightbox */}
			{lightboxItem && (
				<div className="lightbox-overlay" onClick={() => setLightboxItem(null)} role="dialog" aria-modal="true" aria-label="Media viewer">
					<button className="lightbox-close" onClick={() => setLightboxItem(null)} aria-label="Close">
						✕
					</button>
